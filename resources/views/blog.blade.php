            ...
            <div class="row">
                <div class="col-lg-8 p-0">
                    <div class="blog-item">
                        ...
                        <div class="bi-text">
                            <h5><a href="{{ route('blog-details') }}">Vegan White Peach Mug Cobbler With Cardam Vegan White Peach Mug
                                    Cobbler...</a></h5>
                            <ul>
                                <li>by Admin</li>
                                <li>Aug,15, 2019</li>
                    ...
                    <div class="sidebar-option">
                        ...
                        <div class="so-latest">
                            ...
                            <div class="latest-large set-bg" data-setbg="img/letest-blog/latest-1.jpg">
                                <div class="ll-text">
                                    <h5><a href="{{ route('blog-details') }}">This Japanese Way of Making Iced Coffee Is a Game...</a></h5>
                                    <ul>
                                        <li>Aug 20, 2019</li>
                                        <li>20 Comment</li>
                                    </ul>
                            ...
                            <div class="latest-item">
                                ...
                                <div class="li-text">
                                    <h6><a href="{{ route('blog-details') }}">Grilled Potato and Green Bean Salad</a></h6>
                            ...
                            <div class="latest-item">
                                ...
                                <div class="li-text">
                                    <h6><a href="{{ route('blog-details') }}">The $8 French Rosé I Buy in Bulk Every Summer</a></h6>
                                    <span class="li-time">Aug 15, 2019</span>
                                </div>
                            </div>
                            <div class="latest-item">
                                ...
                                <div class="li-text">
                                    <h6><a href="{{ route('blog-details') }}">Ina Garten's Skillet-Roasted Lemon Chicken</a></h6>
                                    <span class="li-time">Aug 15, 2019</span>
                                </div>
                            </div>
                            <div class="latest-item">
                                ...
                                <div class="li-text">
                                    <h6><a href="{{ route('blog-details') }}">The Best Weeknight Baked Potatoes, 3 Creative Ways</a></h6>
                                    <span class="li-time">Aug 15, 2019</span>
                                </div>
                            </div>
                        </div>
