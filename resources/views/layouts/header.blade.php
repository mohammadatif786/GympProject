                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="d-flex align-items-center flex-equal">
                        ...
                        <a href="../../demo13/dist/landing.html">
                            <img alt="Logo" src="assets/media/logos/logo-landing-dark-new.png" class="logo-default h-25px h-lg-30px" />
                            <img alt="Logo" src="assets/media/logos/logo-landing-new.png" class="logo-sticky h-20px h-lg-25px" />
                        </a>
                        <!--end::Logo image-->
                    </div>
                    <!--end::Logo-->
